...
?>
<div class="subheader">
	<h1><?= e($this->strings['project.state.form.name']) ?></h1>
	<br class="cleaner">
</div>
<p>
	<a href="<?= form_url(FormList::PROJECTSTATE); ?>" class="controller-menu"><?= e($this->strings['project.state.form.title_create']) ?></a><span></span>
	<a href="<?= widget_url(WidgetList::PROJECTLIST); ?>" class="controller-menu"><?= e($this->strings['project.list.title']) ?></a><span></span>
</p>
...
<table class="display highlight_row commonDataTable" id="dataTable-<?= $this->getWidgetConnection()->getConnectionId(); ?>">
	<thead>
		<tr>
			<th><?= e($this->strings['project.state.field.name.label']) ?></th>
	...
	<?php foreach ($this->props['issueTypeList'] as $key => $issueType): ?>
		<tr>
				...
				<td>
					<a href="<?= form_url(FormList::PROJECTSTATE, $issueType['id']); ?>"><?= Icons::get(IconNames::EDIT, $this->strings['common.edit'], 'medium'); ?></a>
				</td>
			</tr>
	<?php endforeach; ?>
	</tbody>
