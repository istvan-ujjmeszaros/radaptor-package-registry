...
?>
<div class="subheader">
	<h1><?= e($this->strings['company.description.widget_name']) ?></h1>
	<br class="cleaner">
</div>
<p>
	<a href="<?= widget_url(WidgetList::COMPANYLIST); ?>" class="controller-menu"><?= e($this->strings['company.description.back_to_list']) ?></a><span></span>
	<a href="<?= form_url(FormList::COMPANY, $this->props['companyData']['id']); ?>" class="controller-menu"><?= e($this->strings['common.edit']) ?></a><span></span>
</p>
<table class="descriptionTable">
	<tr>
		<td colspan="4"><h1><?= $this->props['companyData']['name']; ?></h1></td>
	</tr>
	<tr>
		<td style="width:10%" class="label"><?= e($this->strings['common.id']) ?>:</td>
		<td><?= $this->props['companyData']['id']; ?></td>
	...
	<tr>
		<td class="label"><?= e($this->strings['company.field.shortname.label']) ?>:</td>
		<td><?= $this->props['companyData']['shortname']; ?></td>
