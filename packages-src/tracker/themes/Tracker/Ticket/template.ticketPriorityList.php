...
?>
<div class="subheader">
	<h1><?= e($this->strings['ticket.widget.priority_list.name']) ?></h1>
	<br class="cleaner">
</div>
<p>
	<a href="<?= form_url(FormList::TICKETPRIORITY); ?>" class="controller-menu"><?= e($this->strings['ticket.priority.form.title_create']) ?></a><span></span>
...
<table class="display highlight_row commonDataTable" id="dataTable-<?= $this->getWidgetConnection()->getConnectionId(); ?>">
	<thead>
		<tr>
			<th><?= e($this->strings['ticket.priority.field.name.label']) ?></th>
			<th><?= e($this->strings['ticket.priority.field.seq.label']) ?></th>
	...
	<?php foreach ($this->props['issueTypeList'] as $key => $issueType): ?>
		<tr>
			<td><?= $issueType['name']; ?></td>
				<td width="1px"><?= $issueType['seq']; ?></td>
				<td>
					<a href="<?= form_url(FormList::TICKETPRIORITY, $issueType['id']); ?>"><?= Icons::get(IconNames::EDIT, $this->strings['common.edit'], 'medium'); ?></a>
				</td>
			</tr>
	<?php endforeach; ?>
	</tbody>
